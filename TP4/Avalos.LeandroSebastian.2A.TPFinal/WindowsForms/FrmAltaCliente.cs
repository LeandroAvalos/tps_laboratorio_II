...
namespace WindowsForms
{
    public partial class FrmAltaCliente : Form
    {
        ...
        private void rdbSeguroBasico_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.Text = GestionDeArchivos<string>.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroBasico.txt");
            }
            else
            {
                richTextBox1.Clear();
        ...
        private void rdbSeguroIntermedio_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.Text = GestionDeArchivos<string>.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroIntermedio.txt");
            }
            else
            {
                richTextBox1.Clear();
        ...
        private void rdbSeguroContraTodo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.Text = GestionDeArchivos<string>.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroContraTodo.txt");
            }
            else
            {
                richTextBox1.Clear();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int proximoNumeroDeCliente = int.Parse(GestionDeArchivos<string>.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"NumeroCliente.txt"));
                    ...
                    GestionDeArchivos<string>.Txt_Writer($"{AppDomain.CurrentDomain.BaseDirectory}" + @"NumeroCliente.txt", proximoNumeroDeCliente.ToString(),false);
