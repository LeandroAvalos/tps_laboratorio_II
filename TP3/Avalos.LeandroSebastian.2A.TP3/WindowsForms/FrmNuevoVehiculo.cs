...
namespace WindowsForms
{
    public partial class FrmNuevoVehiculo : Form
    {
        ...
        private void rdbSeguroBasico_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                rtbInformacionSeguros.Text = GestionDeArchivosTxt.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroBasico.txt");
            }
            else
            {
        ...
        private void rdbSeguroIntermedio_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                rtbInformacionSeguros.Text = GestionDeArchivosTxt.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroIntermedio.txt");
            }
            else
            {
                rtbInformacionSeguros.Clear();
        ...
        private void rdbSeguroContraTodo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                rtbInformacionSeguros.Text = GestionDeArchivosTxt.Txt_Reader($"{AppDomain.CurrentDomain.BaseDirectory}" + @"SeguroContraTodo.txt");
            }
            else
            {
                rtbInformacionSeguros.Clear();
